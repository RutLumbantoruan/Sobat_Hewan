            ...
            <form id="u_form_update_donasi">
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control" id="u_alasan_donasi" name="alasan" placeholder="Alasan">{{$donasi->alasan}}</textarea>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label for="u_nama_donasi">Nama Hewan</label>
                        <input type="text" class="form-control" id="u_nama_donasi" name="nama" placeholder="Nama Hewan" value="{{$donasi->nama}}">
                    </div>
                    <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="u_lokasi_donasi" name="lokasi" value="{{$donasi->lokasi}}">
                    </div>
                </div>
                <img src="{{asset($donasi->TakeImage)}}" alt="" style="width:50%;">
                <div class="form-group">
                    <label for="u_gambar_donasi">Foto Hewan</label>
                    <input type="file" class="form-control" id="u_gambar_donasi" name="gambar">
                </div>
                <button id="u_tombol_kirim_donasi" onclick="upload_form('#u_tombol_kirim_donasi','#u_form_update_donasi','{{route('donasi_update', $donasi->id)}}', '{{route('adopsi')}}');" class="btn btn-primary">Kirim</button>
            </form>
        </div>
    </section>
</div>

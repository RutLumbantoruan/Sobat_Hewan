...
<script src="{{asset('semicolon/js/components/bs-datatable.js')}}"></script>
<!-- Footer Scripts ============================================= -->
<script src="{{asset('semicolon/js/functions.js')}}"></script>
<script src="{{asset('semicolon/js/chart.js')}}"></script>
<script src="{{asset('semicolon/js/chart-utils.js')}}"></script>

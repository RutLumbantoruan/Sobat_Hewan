            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form_create_donasi">
                        ...
                        <button id="tombol_kirim_donasi" onclick="upload_form_modal('#tombol_kirim_donasi','#form_create_donasi','<?php echo e(route('donasi_store')); ?>','#ModalCreateDonasi');" class="btn btn-primary">Kirim</button>
                    </form>
                </div>
            </div>
        </div>
    </div>
</div><?php /**PATH C:\xampp\htdocs\source\sh FInal\resources\views/theme/modal.blade.php ENDPATH**/ ?>
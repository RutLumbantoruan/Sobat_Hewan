    ...
    <div class="forms-container">
        <div class="signin-signup">
            ...
            <form id="form_register" class="sign-up-form">
                ...
                <img src=<?php echo e('data:image/jpeg;base64,' . $captchaImage); ?> />
                <div class="input-field">
                    <i class="fas fa-lock"></i>
                    <input type="hidden" value="<?php echo e(base64_decode($captchaImage)); ?>" name="realcaptcha" />
...
<?php echo $__env->make('theme.auth',["title" => "Authentication"], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\source\sh FInal\resources\views/auth/main.blade.php ENDPATH**/ ?>
    ...
    <div class="card-body py-7">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="d-flex align-items-center">
                ...
                <span class="text-muted">Menampilkan item ke <?php echo e($paginator->firstItem()); ?> dari <?php echo e($paginator->total()); ?> records</span>
            </div>
        </div>
    </div>
</div>
<?php endif; ?><?php /**PATH C:\xampp\htdocs\source\sh FInal\resources\views/theme/pagination.blade.php ENDPATH**/ ?>